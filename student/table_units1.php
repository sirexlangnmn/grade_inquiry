<tr> 
   ...
   <td>
      <?php
        ...
        "SELECT SUM(gen_ave) FROM grade WHERE student_id = '$id' AND level_id = '$level_id' AND semester = '$semester'") 
        or die(mysqli_error());

        $test_count = mysqli_query($con, 
        "SELECT * FROM grade WHERE gen_ave <> '' and student_id = '$id' AND level_id = '$level_id' AND semester = '$semester'")
        or die(mysqli_error());
