    ...
    <section class="content-header"></section>  <!-- Main Content Here -->  
      <div class="box-body">
         <div class="alert alert-info alert-dismissible">
            <h4 style="margin-bottom: -2px"><i class="glyphicon glyphicon-user"></i>User Table</h4>
          </div>
          <div class="row">
            <div class="col-xl-2 col-md-2 col-xs-12" style="margin-top: -10px">
              <button rel="tooltip"
                      type="submit" 
                      title="Click Here to Add User" 
                      data-toggle="modal" 
                      data-target="#modal_user_insert" 
                      tabindex="-1" 
                      role="dialog"
                      aria-labelledby="myModalLabel" 
                      class='btn btn-danger btn-raised btn-block btn-flat'>
                      <i class="glyphicon glyphicon-plus-sign"></i>
                      <i class="glyphicon glyphicon-user" style="margin-right: 10px"></i>Add User
              </button>  
              <?php include('modal_user_insert.php'); ?>      
            </div>
            <div class="col-xl-7 col-md-7 col-xs-12"></div>
          ...
          <div class="col-xs-12">
            <div class="box">
               <div class="box-body pad table-responsive">
                ...
                <?php include("controller/table/table_search_user.php"); ?>
