          ...
          <div class="row">
            <div class="col-xl-3 col-md-3 col-xs-12" style="margin-top: -10px">
              <button rel="tooltip"
                      ...
                      data-toggle="modal" 
                      data-target="#modal_course_insert" 
                      tabindex="-1" 
                      role="dialog"
                      aria-labelledby="myModalLabel" 
                      class='btn btn-danger btn-raised btn-block btn-flat'>
                      <i class="glyphicon glyphicon-plus-sign"></i>
                      <i class="glyphicon glyphicon-user" style="margin-right: 10px"></i>Add Course
              </button>  
              <?php include('modal_course_insert.php'); ?>      
            </div>
            <div class="col-xl-6 col-md-6 col-xs-12"></div>
          ...
          <div class="col-xs-12">
            <div class="box">
               <div class="box-body pad table-responsive">
                ...
                <?php include("controller/table/table_course.php"); ?>
