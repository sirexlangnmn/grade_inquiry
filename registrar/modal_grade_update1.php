 <!--Sort Grade Modal-->
<div class="modal fade" id="modal_grade_update1<?php echo $grade_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php 
      $student_query=mysqli_query($con, "SELECT * FROM grade where student_id = '$grade_id'")or die(mysql_error());
...
if ($gen_ave  == '1.00'){ 
  ...
  <script>
    window.location = "grade_view2.php<?php echo '?id='.$get_id;  ?>";    
  </script>
<?php   
  }