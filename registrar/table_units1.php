<tr> 
        ...
        /* $result = mysqli_query($con, "SELECT SUM(unit) FROM grade WHERE student_id = '$get_id' AND school_year = '$school_year' AND semester = '$term'") or die(mysqli_error());*/
          $result = mysqli_query($con, "SELECT SUM(subject.unit) 
                                             ...
                                             WHERE students.student_id = '$student_id'
                                               ...
                                               AND grade.level_id = '$level_id'") or die(mysqli_error());
   ...
   <td>
      <?php
        ...
        "SELECT SUM(gen_ave) FROM grade WHERE student_id = '$student_id' AND level_id = '$level_id' AND semester = '$semester'") 
        or die(mysqli_error());

        $test_count = mysqli_query($con, 
        "SELECT * FROM grade WHERE gen_ave <> '' and student_id = '$student_id' AND level_id = '$level_id' AND semester = '$semester'")
        or die(mysqli_error());
